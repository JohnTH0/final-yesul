...
AI 기반 전통주 추천을 통해 사용자는 자신의 취향에 맞는 전통주를 쉽게 발견할 수 있음

직관적인 UI/UX와 **간편 로그인(Kakao, Naver)**으로 모든 연령대가 접근 가능한 서비스 환경 제공

커뮤니티 및 1:1 문의, 실시간 알림 기능을 통해 사용자 간 활발한 상호작용과 정보 교류 촉진

운영자 측면

Redis 기반 트래픽 분석, 관리자 로그인 기록 등 운영 모니터링 기능 강화

관리자 페이지에서 실시간으로 1:1 문의에 대응 가능, 운영 효율성 향상

로그인 기록 및 통계 분석을 통해 보안성과 운영 투명성 확보

기술적 기대효과

AI Prompting 기법(Naver ClovaX + Role/CoT Prompting) 적용 경험을 통해 AI 응답 품질 향상

**2FA 보안 인증(Google T-OTP)**을 적용하여 보안 강화 경험 축적

OAuth 기반 로그인, WebSocket 기반 채팅, S3 이미지 업로드, Docker+CI/CD 자동 배포 등 실제 서비스 수준의 백엔드 인프라 구성 경험
...
AI 추천, 채팅, 커뮤니티, 인증 등 다양한 기술 스택을 유기적으로 연결하여 완성도 높은 기능 제공

일일 스크럼과 회의를 통해 코드 병합을 원활히 해결하고 협업의 중요성과 소통 능력 증진

아쉬운 점

다양한 기술을 습득하고 구현하는 과정을 병행하다 보니, 일부 기능의 완성도와 디테일 측면에서 퀄리티를 높이기엔 시간이 부족했던 점

기획 및 설계 단계에서 기능 우선순위나 전체적인 일정 조율에 대한 고려가 부족해, 이후 구현 단계에서 여러 번 수정이 필요했고 비효율적인 리팩토링이 발생
...
| 📋 Sprint Board   | 칸반 보드 (Sprint 관리)           | [바로가기](https://your-sprint-board-link.com) |
| 🧭 Milestone & Issue | 마일스톤 및 이슈 관리 페이지     | [바로가기](https://your-milestone-link.com) |
| 🗂 WBS 문서        | 작업 분할 구조 (WBS)              | [바로가기](https://your-wbs-link.com) |
| 🗺 ERD             | 데이터베이스 설계 (ERDCloud)      | [바로가기](https://your-erd-link.com) |
